...
public class FichierTest {
	...
	public void testMethodeVerifierCommande () {
		...
		// Commande avec client et plat existant, mais quantité de commande décimale
		tab[0] = "Roger";
		tab[1] = "Poutine";
		tab[2] = "2.5";
		
		messageErreur = "\nLa commande (Roger Poutine 2.5) est invalide car la quantité dans la commande est erronée.\n";
		
		assertEquals(messageErreur, fichier.verifierCommande(tab));
		assertEquals(4, fichier.getListeMessagesErreur().size());
		
		// Commande avec client inexistant, plat existant et quantité de commande décimale
		tab[0] = "Jeff";
		tab[1] = "Poutine";
		tab[2] = "2.5";
		
		messageErreur = "\nLa commande (Jeff Poutine 2.5) est invalide car le client n'existe pas et quantité dans la commande est erronée.\n";
		
		assertEquals(messageErreur, fichier.verifierCommande(tab));
		assertEquals(5, fichier.getListeMessagesErreur().size());
	
		// Commande avec client existant, plat inexistant et quantité de commande décimale
		tab[0] = "Roger";
		tab[1] = "Bacon";
		tab[2] = "2.5";
		
		messageErreur = "\nLa commande (Roger Bacon 2.5) est invalide car le plat n'existe pas et quantité dans la commande est erronée.\n";
